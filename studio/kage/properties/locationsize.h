 ...
 */
...
#ifndef GTKMM_KAGE_PROP_LOCATION_SIZE_H
	#define GTKMM_KAGE_PROP_LOCATION_SIZE_H
	...
	class PropertyLocationSize : public Gtk::HBox {
		public:
...
#endif //GTKMM_KAGE_PROP_LOCATION_SIZE_H
