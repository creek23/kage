 ...
 */
...
#ifndef GTKMM_KAGE_SCENES_UI_H
	#define GTKMM_KAGE_SCENES_UI_H
	...
	class KageScenesUI : public Gtk::DrawingArea {
		public:
			...
			void setFocus();
			void renderStage(); ///when sceneUI item is double clicked, update Stage
