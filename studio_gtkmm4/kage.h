...
//	#include "register.h" -- not implemented yet; this is to gather users for support group
	...
	class Kage : public Gtk::ApplicationWindow {
		public:
...
//			void New_onClick();
			...
			Gtk::MessageDialog disregardUnsavedWorkDialog;
			void onDisregardUnsavedWorkResponse(int response_id);
			//Gtk::FileChooserDialog fileOpenDialog;
			void onFileOpenDialogResponse(int response_id, Gtk::FileChooserDialog *dialog);
			void onFileSaveDialogResponse(int response_id, Gtk::FileChooserDialog *dialog);
			void onExportKSDialogResponse(int response_id, Gtk::FileChooserDialog *dialog);
			void onExportHTML5DialogResponse(int response_id, Gtk::FileChooserDialog *dialog);
			void onExportSVGDialogResponse(int response_id, Gtk::FileChooserDialog *dialog);
			void onExportPNGDialogResponse(int response_id, Gtk::FileChooserDialog *dialog, bool p_transparent = false);
			void onExportPNGSequenceDialogResponse(int response_id, Gtk::FileChooserDialog *dialog);
			void onExportSpritesheetDialogResponse(int response_id, Gtk::FileChooserDialog *dialog);
			void onExportAVIDialogResponse(int response_id, Gtk::FileChooserDialog *dialog);
			void onProjectSaveDialogResponse(int response_id, Gtk::FileChooserDialog *dialog);
			...
			Gtk::Box m_VBoxTimelineLayer;
			Gtk::Paned m_Timeline_HPaned;
			Gtk::Box m_Timeline_Layer_VBox;
			Gtk::Box m_Timeline_Layer_Add_HBox;
			...
			Gtk::Box m_Timeline_Frame_VBox1;
			Gtk::Label m_TimelineFrame_Label;
			Gtk::Box m_Timeline_Frame_VBox2;
			Gtk::Box m_VBoxTimelineFrame; //to be deleted
			Gtk::ScrolledWindow m_Timeline_Layer_ScrolledWindow;
			Gtk::ScrolledWindow m_Timeline_Frame_ScrolledWindow;
			Gtk::Box m_VBoxToolbar_Holder;
			Gtk::Box m_Box1;
			Gtk::Box m_PropertyBox;
			Gtk::Separator m_Separator;
			Gtk::Separator m_Separator_Toolbar1;
			Gtk::Separator m_Separator_Toolbar2;
			Gtk::Separator m_Separator_Toolbar3;
			Gtk::Separator m_Separator_Toolbar4;
			Gtk::Label m_LabelProp;
			//Stage Property items
				Gtk::Box m_PropStage;
				Gtk::Box m_PropStageV1;
				Gtk::Box m_PropStageV2;
...
//				Gtk::ColorSelection m_ColorSelectionStage;
			...
			Gtk::Scrollbar     m_Property_Pane_VScrollbar;
			//Fill Property items
				Gtk::Box m_PropFill;
					bool _propFillVisible = false;
				Gtk::Box m_PropFillV1;
				Gtk::Box m_PropFillV2;
			...
			//Stroke Property items
				Gtk::Box m_PropStroke;
					bool _propStrokeVisible = false;
				Gtk::Box m_PropStrokeV1;
				Gtk::Box m_PropStrokeV2;
			...
			//Toggle for Fill/Stroke Property items
				Gtk::Box m_PropFillLabel;
				Gtk::Box m_PropFillLabelV1;
				Gtk::Box m_PropFillLabelV2;

				Gtk::Box m_PropStrokeLabel;
				Gtk::Box m_PropStrokeLabelV1;
				Gtk::Box m_PropStrokeLabelV2;
			
			//X/Y Width/Height Shape's properties
				Gtk::Box m_propLocationSize;
				Gtk::Box m_propLocationSizeV1;
				Gtk::Box m_propLocationSizeV2;
				Gtk::Label m_LabelX;
				Gtk::Entry m_EntryX;
					void EntryX_onEnter();
				Gtk::Label m_LabelY;
			...
			//X/Y Node's properties
				Gtk::Box m_propNodeXY;
				Gtk::Box m_propNodeXYV1;
				Gtk::Box m_propNodeXYV2;
			...
			//Frame's properties
				Gtk::Box m_propFrameTween;
				Gtk::Box m_propFrameTweenV1;
				Gtk::Box m_propFrameTweenV2;
			...
			Glib::RefPtr<Gio::SimpleAction> _boolTools[10];
			...
			Gtk::Scrollbar m_Timeline_HScrollbar;
			Gtk::Scrollbar m_Timeline_VScrollbar;
			Gtk::Box m_Timeline_HBox;
			
			Gtk::Paned m_VPane_Timeline;
			Gtk::Paned m_HPane_DrawingArea;
...
//			void ToolSelect_onClick();
		...
		public:
			...
			void Tool_onClick(int p_id);
			void onAboutResponse(int response_id, KageAbout *dialog);
