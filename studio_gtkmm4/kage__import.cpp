...
//			m_HPane_DrawingArea.add1(m_KageStage);
			m_HPane_DrawingArea.add1(m_Stage_Pane_ScrolledWindow);
				//m_Stage_Pane_ScrolledWindow.set_policy(Gtk::POLICY_NEVER, Gtk::POLICY_EXTERNAL);
...
//`forceRenderFrames() doesn't serve the purpose why m_ComboX/Y tween state is updated from here and not on Kage::renderFrames();
