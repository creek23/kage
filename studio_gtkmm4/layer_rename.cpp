...
//	add_button(Gtk::Stock::OK, Gtk::RESPONSE_OK);
	...
	set_child(m_HBox);//, Gtk::PACK_SHRINK);
		m_HBox.append(_label);
		m_HBox.append(_txtLabel);//, Gtk::PACK_SHRINK);
			_txtLabel.set_text(p_layer->getLabel());
			_layer = p_layer;
			_txtLabel.signal_changed().connect( sigc::mem_fun(*this, &LayerRenameDialog::EntryLayerLabel_onEnter) );
